...
variableList = [
    ...
    cms.PSet(
      ...
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("nTrkDeepFlavourInput"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring(),
    ),
    cms.PSet(
      variable    = cms.string("DeepFlavourInput_nFirstTrk"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepFlavourInput_nFirstTrk"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring(),
    ),
    cms.PSet(
      variable    = cms.string("DeepFlavourInput_nLastTrk"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepFlavourInput_nLastTrk"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring(),
    ),
    cms.PSet(
